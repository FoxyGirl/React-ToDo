...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ToDoAppJsx = __webpack_require__(159);

	var _ToDoAppJsx2 = _interopRequireDefault(_ToDoAppJsx);

	_reactDom2['default'].render(_react2['default'].createElement(_ToDoAppJsx2['default'], null), document.getElementById('mount-point'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _componentsNoteEditorNoteEditorJsx = __webpack_require__(160);

	var _componentsNoteEditorNoteEditorJsx2 = _interopRequireDefault(_componentsNoteEditorNoteEditorJsx);

	var _componentsProgressBarProgressBarJsx = __webpack_require__(165);

	var _componentsProgressBarProgressBarJsx2 = _interopRequireDefault(_componentsProgressBarProgressBarJsx);

	var _componentsNotesListNotesListJsx = __webpack_require__(168);

	var _componentsNotesListNotesListJsx2 = _interopRequireDefault(_componentsNotesListNotesListJsx);

	var _componentsFilterListFilterListJsx = __webpack_require__(174);

	var _componentsFilterListFilterListJsx2 = _interopRequireDefault(_componentsFilterListFilterListJsx);

	var _componentsCleanerCleanerJsx = __webpack_require__(178);

	var _componentsCleanerCleanerJsx2 = _interopRequireDefault(_componentsCleanerCleanerJsx);
	...
	var TodoApp = (function (_React$Component) {
	    ...
	    function TodoApp(props) {
	        ...
	        this.state = {
	            notes: [],
	            displayedNotes: [],
	            filters: [{ idF: 101, name: 'all', isActive: true }, { idF: 102, name: 'new', isActive: false }, { idF: 103, name: 'done', isActive: false }]
	        };
	    ...
	    _createClass(TodoApp, [{
	        ...
	        value: function componentWillMount() {
	            var localNotes = JSON.parse(localStorage.getItem('toDoNotes'));
	        ...
	        value: function handleNoteAdd(newNote) {
	            ...
	            this.setState({ notes: newNotes, displayedNotes: newNotes }, function () {
	                var curFilter = newFilters.filter(function (item) {
	                    return item.isActive === true;
	                });
	                if (curFilter[0].name === 'done') {
	                    _this.handleNoteFilter('new');
	                } else {
	                    _this.handleNoteFilter(curFilter[0].name);
	                }
	            });
	        }
	    }, {
	        ...
	        key: 'handleNoteFilter',
	        value: function handleNoteFilter(filter) {
	            var newNotes = this.state.notes.slice();
	            var newFilters = this.state.filters.slice();
	            var displayedNotes = [];
	            ...
	            switch (filter) {
	                case 'new':
	                    displayedNotes = newNotes.filter(function (note) {
	                        return note.isDone === false;
	                    });
	                    break;
	                case 'done':
	        ...
	        value: function render() {
	            var newNotes = this.state.notes.slice();
	            var doneItems = newNotes.filter(function (note) {
	                return note.isDone;
	            });
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_componentsNoteEditorNoteEditorJsx2['default'], { onNoteAdd: this.handleNoteAdd }),
	                this.state.notes.length > 0 && _react2['default'].createElement(_componentsProgressBarProgressBarJsx2['default'], {
	                    itemsCount: this.state.notes.length,
	                    itemsDoneCount: doneItems.length }),
	                this.state.displayedNotes.length > 0 ? _react2['default'].createElement(_componentsNotesListNotesListJsx2['default'], {
	                    notes: this.state.displayedNotes,
	                    onNoteDelete: this.handleNoteDelete,
	                    onNoteChange: this.handleNoteChange,
	                    onNoteDone: this.hadleNoteDone }) : _react2['default'].createElement(
	                    'div',
	                    { className: 'not-found' },
	                    'Nothing is here!'
	                ),
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(_componentsFilterListFilterListJsx2['default'], {
	                        filters: this.state.filters,
	                        onNoteFilter: this.handleNoteFilter }),
	                    doneItems.length > 0 && _react2['default'].createElement(_componentsCleanerCleanerJsx2['default'], { onDoneClean: this.hadleDoneClean })
	                )
	            );
	        }
	    }]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ToDoApp.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NoteEditor = (function (_React$Component) {
	    ...
	    function NoteEditor(props) {
	        ...
	        _get(Object.getPrototypeOf(NoteEditor.prototype), 'constructor', this).call(this, props);
	        this.state = { text: '' };
	    ...
	    _createClass(NoteEditor, [{
	        ...
	        value: function componentDidMount() {
	            var inputEdit = _reactDom2['default'].findDOMNode(this.refs.textarea);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProgressBar = (function (_React$Component) {
	    ...
	    _createClass(ProgressBar, [{
	        key: 'render',
	        value: function render() {
	            var percent = Math.round(this.props.itemsDoneCount / this.props.itemsCount * 100);
	            var barStyle = { width: percent + '%' };
	            var notDoneItem = this.props.itemsCount - this.props.itemsDoneCount;
	            var activeWord = notDoneItem !== 1 ? 'tasks' : 'task';
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('span', { className: 'progress-bar__bar', style: barStyle })
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'progress-bar__footer' },
	                    notDoneItem !== 0 ? _react2['default'].createElement(
	                        'p',
	                        ...
	                        'p',
	                        { className: 'progress-bar__text  progress-bar__text--success' },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ProgressBar.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./ProgressBar.less", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./ProgressBar.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NotesList = (function (_React$Component) {
	    ...
	    _createClass(NotesList, [{
	        ...
	        value: function render() {
	            ...
	            var onNoteDone = this.props.onNoteDone;
	            var onNoteChange = this.props.onNoteChange;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "NotesList.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./NotesList.less", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./NotesList.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".notes-list {\n  list-style: none;\n  width: 100%;\n  max-width: 600px;\n  margin: 20px auto;\n  padding: 0;\n}\n", ""]);
	...
	var Note = (function (_React$Component) {
	    ...
	    _createClass(Note, [{
	        ...
	        value: function handleEdit() {
	            ...
	            var newIsEdit = !this.state.isEdit;
	            this.setState({ isEdit: newIsEdit });

	            var inputEdit = _reactDom2['default'].findDOMNode(this.refs.editing);
	        ...
	        key: 'handleEditNode',
	        value: function handleEditNode(e) {
	            this.setState({ editText: e.target.value });
	        }
	    }, {
	        key: 'handleNoteChanged',
	        value: function handleNoteChanged(e) {
	        ...
	        key: 'render',
	        value: function render() {
	            var noteClass = (this.props.isDone ? 'note note--done' : 'note') + ' \n        ' + (this.state.isEdit ? 'note--edit' : '');
	            ...
	            return _react2['default'].createElement(
	                ...
	                this.props.isDone || _react2['default'].createElement(
	                    'span',
	                    { className: 'note__edit', ref: 'edit',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FilterJsx = __webpack_require__(177);
	...
	var FilterList = (function (_React$Component) {
	    ...
	    _createClass(FilterList, [{
	        key: 'render',
	        value: function render() {
	            var onNoteFilter = this.props.onNoteFilter;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "FilterList.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./FilterList.less", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./FilterList.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Filter = (function (_React$Component) {
	    ...
	    _createClass(Filter, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var filterClass = this.props.isActive ? "filter filter--active" : "filter";
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Filter.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Cleaner = (function (_React$Component) {
	    _inherits(Cleaner, _React$Component);

	    function Cleaner() {
	        _classCallCheck(this, Cleaner);

	        _get(Object.getPrototypeOf(Cleaner.prototype), 'constructor', this).apply(this, arguments);
	    }
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'button',
	                    {
	                        ...
	                        onClick: this.props.onDoneClean },
	                    'Clear Done'
	                )
	            );
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\React_Essential_ITDVN_copy\\04-routing-and-es6\\react-to-do-1\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Cleaner.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./Cleaner.less", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/index.js!./Cleaner.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/autoprefixer-loader/index.js!../node_modules/less-loader/index.js!./ToDoApp.less", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/autoprefixer-loader/index.js!../node_modules/less-loader/index.js!./ToDoApp.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
